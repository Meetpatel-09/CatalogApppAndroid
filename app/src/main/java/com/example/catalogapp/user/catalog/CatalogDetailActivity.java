                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot2) {
                            if (snapshot2.child(productID).exists()) {
                                ...
                                bWatchlist.setOnClickListener(view -> {
                                    FirebaseDatabase.getInstance().getReference().child("watchlist").child(firebaseUser.getUid()).child(productID).removeValue();
                                ...
                                bWatchlist.setOnClickListener(view -> {
                                    FirebaseDatabase.getInstance().getReference().child("watchlist").child(firebaseUser.getUid()).child(productID).setValue(true);
